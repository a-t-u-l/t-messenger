...
public class MQTTBase {
    ...
    public void subscribeClient(MqttClient client, String topic, final JavaClient clientCall) throws MqttException {
            ...
            public void run() {
                ...
                while (true) {
                    ...
                    try {
                        ...
                        send.subscribeClient(client, mqttSettings.getTopic(), null);
        ...
        Thread t2 = new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    receive.subscribeClient(client, mqttSettings.getTopic(), null);
                } catch (MqttException e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
